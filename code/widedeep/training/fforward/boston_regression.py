...
""" Test to check that the defined architecture works for a very
simple dataset such as Boston Housing UCI """
...
if __name__ == '__main__':
    ...
    dataset = BostonSettings(dataset_location=FLAGS.data_location)
